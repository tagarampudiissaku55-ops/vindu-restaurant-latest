      ...
      <section className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div>
          ...
          <div className="mt-8 space-y-4">
            ...
            <div className="glass rounded-2xl p-5">
              <p className="text-xs font-bold uppercase tracking-wider text-saffron">Feedback</p>
              <a
                href={`https://wa.me/${restaurantInfo.whatsapp}?text=${encodeURIComponent(
                  'Hello Vindu Restaurant, I would like to share feedback about my experience.',
                )}`}
                target="_blank"
                rel="noreferrer"
                className="mt-2 block font-display text-2xl font-bold text-saffron"
              >
                Send Feedback
              </a>
              <p className="mt-2 text-sm leading-7 text-white/66">
                Share your feedback on WhatsApp so we can keep improving our service.
              </p>
            </div>
            <div className="glass rounded-2xl p-5">
              <p className="text-xs font-bold uppercase tracking-wider text-saffron">Instagram</p>
              <a href="https://www.instagram.com/vindu.restaurant" target="_blank" rel="noreferrer" className="mt-2 block font-display text-2xl font-bold text-saffron">
                @vindu.restaurant
              </a>
            </div>
            <div className="glass rounded-2xl p-5">
