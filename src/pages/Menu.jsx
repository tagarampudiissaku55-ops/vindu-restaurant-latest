    ...
    <main className="mx-auto max-w-7xl px-4 pb-20 pt-28 sm:px-6">
      <motion.section initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-7 text-white/66">
          Browse categories, search dishes, view prices, and order instantly by tapping any dish card.
        </p>
        <p className="mt-2 max-w-2xl text-sm leading-7 text-white/66">
          Need feedback or help? Visit the contact page to send us a message on WhatsApp.
        </p>
